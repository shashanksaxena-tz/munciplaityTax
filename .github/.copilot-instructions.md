...
1. Check the specification: `specs/*/spec.md`
2. Review data model: `specs/*/data-model.md`
3. Check API contracts: `specs/*/contracts/`
4. Follow research decisions: `specs/*/research.md`
